                                ...
                                <form onSubmit={handleSubmit} className="space-y-5 relative z-10">
                                    ...
                                    <div className="grid sm:grid-cols-2 gap-4">
                                        <div className="space-y-1.5">
                                            ...
                                            <Input placeholder="John Smith" required className="bg-transparent border-slate-300 h-10 rounded-lg focus:ring-primary focus:border-primary text-slate-900 text-sm px-3 hover:border-slate-400 transition-all placeholder:text-slate-400" />
                                        </div>
                                        <div className="space-y-1.5">
                                            <label className="text-[11px] font-bold tracking-wider uppercase text-slate-600 ml-0.5">Business name</label>
                                            <Input placeholder="Smith Solar Installations" required className="bg-transparent border-slate-300 h-10 rounded-lg focus:ring-primary focus:border-primary text-slate-900 text-sm px-3 hover:border-slate-400 transition-all placeholder:text-slate-400" />
                                        </div>
                                    </div>
                                    ...
                                    <div className="grid sm:grid-cols-2 gap-4">
                                        <div className="space-y-1.5">
                                            ...
                                            <Input type="tel" placeholder="0412 345 678" required className="bg-transparent border-slate-300 h-10 rounded-lg focus:ring-primary focus:border-primary text-slate-900 text-sm px-3 hover:border-slate-400 transition-all placeholder:text-slate-400" />
                                        </div>
                                        <div className="space-y-1.5">
                                    ...
                                    <div className="pt-2">
                                        <Button type="submit" variant="hero" className="w-full h-12 text-base font-bold shadow-lg hover:shadow-primary/20 transition-all">
                                            Request call
                                        </Button>
                                    </div>
