...
async function checkOldSquads() {
    console.log('Checking squad_ids in oldest 50 calls...');
    ...
    if (error) {
        ...
        const squads = new Set(data.map(c => c.squad_id || 'NULL'));
        console.log('Old Unique Squad IDs:', Array.from(squads));
    }
}
